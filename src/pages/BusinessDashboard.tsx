                              ...
                              {ev.meetingUrl && (
                                <div className="flex gap-1.5 mt-1">
                                  <a
                                    ...
                                    rel="noopener noreferrer"
                                    onClick={(e) => e.stopPropagation()}
                                    className="flex-1 inline-flex items-center justify-center gap-1.5 text-[11px] font-bold text-white bg-emerald-600 hover:bg-emerald-700 h-8 rounded-lg transition-colors shadow-sm"
                                  >
                                  ...
                                  <Button
                                    ...
                                    className="inline-flex items-center justify-center gap-1 text-[11px] font-bold text-white bg-primary hover:bg-primary/90 h-8 px-2.5 rounded-lg shadow-sm"
                                  >
                                    <Mail className="w-3.5 h-3.5" /> Send Email
                                  </Button>
                                </div>
